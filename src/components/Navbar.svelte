    ...
    <div class="w-full container mx-auto  flex justify-between px-4 bg-white rounded-md">
     <div class=" md:px-2 m-0 font-medium gap-2 w-fit p-2 rounded-md flex items-center justify-center ">
        ...
        /></a>
         <a href="/" >
          ...
          alt="logo"
          class="items-center justify-center  h-16 z-[100]"
        /></a>
     ...
     <main class=" flex  items-start px-7 my-auto">
        <div style="font-family: Museo-Sans, sans-serif;" class="flex my-auto  {scrolled?'':''}">
            ...
            <a href="/#Vision"  class="md:flex page-scroll cursor-pointer hidden px-4 py-3  md:py-1 uppercase   text-sm hover:text-green-900">Vision</a>
            ...
            <a href="/#Highlights" class="md:flex page-scroll hidden cursor-pointer  px-4 py-3  md:py-1 uppercase   text-sm hover:text-green-900">Highlights</a>
